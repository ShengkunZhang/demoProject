 ...
 *  普通时连线颜色
 */
@property (nonatomic, strong) UIColor *CircleConnectLineNormalColor;

/**
 *  错误时连线颜色
 */
@property (nonatomic, strong) UIColor *CircleConnectLineErrorColor;

/**
 *  连线宽度
 */
@property (nonatomic, assign) float CircleConnectLineWidth;
